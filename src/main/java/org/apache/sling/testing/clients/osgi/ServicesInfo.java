...
public class ServicesInfo {
    ...
    public ServicesInfo(JsonNode root) throws TestingValidationException {
        ...
        if (root.get("status") == null) throw new TestingValidationException("No Status returned!");
        if (root.get("serviceCount") == null) throw new TestingValidationException("No serviceCount returned!");
    }
    ...
    private List<JsonNode> findBy(
            String key, String value, boolean onlyReturnFirstMatch, boolean arrayContainingMatch) {
