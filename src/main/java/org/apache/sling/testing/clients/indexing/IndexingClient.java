...
public class IndexingClient extends SlingClient {
    ...
    /**
     * <p>Retries cleaning all the data generated by {@link #install()} and {@link #waitForAsyncIndexing(long, long)}.</p>
     *
     * <p>User must manually call this if needed, as opposed to {@link #install()}, which is called
     * automatically.</p>
     *
     * @throws TimeoutException if retry operation times out and the path still exists
     * @throws InterruptedException if the retry operation was interrupted by the user
     */
