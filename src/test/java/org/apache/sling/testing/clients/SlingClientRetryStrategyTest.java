...
public class SlingClientRetryStrategyTest {
    ...
    public void testRetryReallyUnavailable() throws Exception {
        ...
        try {
            ...
            assertThat(
                    err.getMessage(),
                    CoreMatchers.containsString("Expected HTTP Status: 200 . Instead 503 was returned!"));
        }
    ...
    public void testRetryReallyInternalError() throws Exception {
        ...
        try {
            ...
            assertThat(
                    err.getMessage(),
                    CoreMatchers.containsString("Expected HTTP Status: 200 . Instead 500 was returned!"));
        }
        assertEquals(MAX_RETRIES + 1, requestCount);
    }
